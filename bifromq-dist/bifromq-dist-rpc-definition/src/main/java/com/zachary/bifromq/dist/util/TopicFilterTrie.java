...
import static com.zachary.bifromq.dist.util.TopicUtil.SYS_PREFIX;
        ...
        private class ChildAccessor {
            ...
            private void genFilterTrie(boolean startMatching) {
                ...
                switch (node.levelName()) {
                    case "#": {
                        filterTrie = TopicFilterTrieMultiLevel.INSTANCE;
                        break;
                    }
                    case "+": {
                        ...
                        filterTrie = new TopicFilterTrieMergedLevel("+", grandChildren,
                    ...
                    default: {
                        ...
                        filterTrie = new TopicFilterTrieMergedLevel(node.levelName(), grandChildren,
                            startMatching && isMatchTopic);
                        break;
                    }
                }
