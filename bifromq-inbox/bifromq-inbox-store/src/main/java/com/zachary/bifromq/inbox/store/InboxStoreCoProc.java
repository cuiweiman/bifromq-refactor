...
import com.zachary.bifromq.inbox.storage.proto.GCReply;
...
import com.zachary.bifromq.inbox.storage.proto.InboxMessageList;
...
import com.zachary.bifromq.inbox.storage.proto.UpdateReply;
...
import static com.zachary.bifromq.inbox.util.KeyUtil.buildMsgKey;
import static com.zachary.bifromq.inbox.util.KeyUtil.isInboxMetadataKey;
import static com.zachary.bifromq.inbox.util.KeyUtil.isQoS0MessageKey;
import static com.zachary.bifromq.inbox.util.KeyUtil.isQoS1MessageKey;
import static com.zachary.bifromq.inbox.util.KeyUtil.isQoS2MessageIndexKey;
import static com.zachary.bifromq.inbox.util.KeyUtil.parseQoS2Index;
import static com.zachary.bifromq.inbox.util.KeyUtil.parseScopedInboxId;
import static com.zachary.bifromq.inbox.util.KeyUtil.parseSeq;
import static com.zachary.bifromq.inbox.util.KeyUtil.qos0InboxMsgKey;
import static com.zachary.bifromq.inbox.util.KeyUtil.qos0InboxPrefix;
import static com.zachary.bifromq.inbox.util.KeyUtil.qos1InboxMsgKey;
import static com.zachary.bifromq.inbox.util.KeyUtil.qos1InboxPrefix;
import static com.zachary.bifromq.inbox.util.KeyUtil.qos2InboxIndex;
import static com.zachary.bifromq.inbox.util.KeyUtil.qos2InboxMsgKey;
import static com.zachary.bifromq.inbox.util.KeyUtil.qos2InboxPrefix;
